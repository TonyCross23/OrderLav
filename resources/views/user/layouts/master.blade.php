                        ...
                        <div class="navbar-nav ml-auto py-0 d-none d-lg-block">
                                ...
                                <div class="dropdown d-inline me-5">
                                    <a class="dropdown-toggle text-decoration-none " href="#" role="button" data-bs-toggle="dropdown" aria-expanded="false">
                                        ...
                                        <i class="fa-solid fa-chevron-down text-white fs-6"></i>
                                    </a>

                                    <ul class="dropdown-menu">
                                      <li><a class="dropdown-item" href="{{ route('user#updatePage') }}">Profile</a></li>
                                      <li><a class="dropdown-item" href="{{ route('user#passwordChangePage') }}">Password Change</a></li>
