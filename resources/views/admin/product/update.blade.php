                ...
                <div class="card">
                    <div class="card-body">
                        <div class="card-title">
                            <h3 class="text-center title-2">Update Pizza List</h3>
                        </div>
                        <hr>
                                ...
                                <div class="row">
                                    <div class="col-4 offset-1">
                                        ...
                                        <div class="mt-4">
                                            ...
                                            <input type="file" name="pizzaImage" class="form-control @error('image') is-invalid @enderror">
                                            @error('image')
                                    ...
                                    <div class=" row col-6 ">
                                        <div class="form-group">
                                            ...
                                            <input id="cc-pament" name="pizzaName" type="type" value="{{ old('pizzaName',$pizza->name) }}" class="form-control @error('pizzaName') is-invalid @enderror"   aria-required="true" aria-invalid="false" placeholder="Enter Pizza">
                                            @error('pizzaName')
                                                <div class="invalid-feedback">
                                                    {{ $message }}
                                                </div>
                                        ...
                                        <div class="form-group">
                                            <label  class="control-label mb-1">Descrition</label>
                                            <input type="hidden"   >
                                            <textarea name="pizzaDescription" class="form-control @error('pizzaDescription') is-invalid @enderror" cols="10" rows="5">{{ old('pizzaDescription',$pizza->description) }}</textarea>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input type="hidden"   >
                                            <input name="description" value="{{ $pizza->view_count }}" disabled class="form-control" cols="10" rows="5">
                                        </div>
